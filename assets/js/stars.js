...
const catchSound = new Audio('/assets/audio/catch_star.wav'); // Preload sound
...
function drawBasket() {
  ...
  ctx.beginPath();
  ctx.moveTo(basketX + 10, basketY);
  ctx.lineTo(basketX + basketWidth - 10, basketY);
  ctx.quadraticCurveTo(
    basketX + basketWidth + 5,
    basketY + basketHeight / 2,
    basketX + basketWidth - 10,
    basketY + basketHeight
  );
  ctx.lineTo(basketX + 10, basketY + basketHeight);
  ctx.quadraticCurveTo(
    basketX - 5,
    basketY + basketHeight / 2,
    basketX + 10,
